...
class yogapage3 extends StatefulWidget {
  ...
  @override
  _yogapage3State createState() => _yogapage3State();
}

class _yogapage3State extends State<yogapage3> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/yogavideos/yoga3.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
