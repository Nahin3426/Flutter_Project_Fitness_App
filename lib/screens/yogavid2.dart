...
class yogapage2 extends StatefulWidget {
  ...
  @override
  _yogapage2State createState() => _yogapage2State();
}

class _yogapage2State extends State<yogapage2> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/yogavideos/yoga2.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
