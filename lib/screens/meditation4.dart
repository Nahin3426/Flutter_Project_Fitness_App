...
class meditationpage4 extends StatefulWidget {
  final int sessionNum;

  const meditationpage4({
    Key? key,
    required this.sessionNum,
  }) : super(key: key);

  @override
  _meditationpage4State createState() => _meditationpage4State();
}

class _meditationpage4State extends State<meditationpage4> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/meditationvideos/med4.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
