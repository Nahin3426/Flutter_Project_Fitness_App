...
class meditationpage2 extends StatefulWidget {
  final int sessionNum;

  const meditationpage2({
    Key? key,
    required this.sessionNum,
  }) : super(key: key);

  @override
  _meditationpage2State createState() => _meditationpage2State();
}

class _meditationpage2State extends State<meditationpage2> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/meditationvideos/med2.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
