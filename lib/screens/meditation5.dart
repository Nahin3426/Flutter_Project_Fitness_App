...
class meditationpage5 extends StatefulWidget {
  final int sessionNum;

  const meditationpage5({
    Key? key,
    required this.sessionNum,
  }) : super(key: key);

  @override
  _meditationpage5State createState() => _meditationpage5State();
}

class _meditationpage5State extends State<meditationpage5> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.asset('assets/meditationvideos/med5.mp4')
      ..initialize().then((_) {
        setState(() {});
      });
